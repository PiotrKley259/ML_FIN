...
TRADING_PARAM = {
    ...
    'enable_bayesian_tuning' : False, #True mais attention très couteux en calcul
    ...
    'feature_selection_method': 'polynomial_features',  # 'lasso', 'elastic_net', 'adaptive_lasso' , 'variance_corr' ,'polynomial_features' , 'mutual_info'
    'feature_selection_frequency': 5,
    'max_features': None,
    'min_features': 50,
    'lasso_alpha_range': (1e-4, 1e2),
...
def main():
    ...
    if MODELS_TO_RUN.get('deep_learning', False):
        print("\n=== EXÉCUTION DEEP LEARNING + SELECTION ===")
